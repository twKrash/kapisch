...
| Surface | Verified status for the 1.2.2 release candidate |
| --- | --- |
| Windows 11 + Codex Desktop + WSL2 | 1.0.1 release baseline passed; 1.2.2 live acceptance remains pending. |
| Linux | Historical live 1.0.0 flow passed; 1.2.2 automated evidence is recorded separately. |
...
After the immutable 1.2.2 tag is published, the released installation command is:

```text
codex plugin marketplace add twKrash/kapisch --ref v1.2.2
...
- [Windows 1.2.2 acceptance template](plugins/kapisch/docs/acceptance-windows-v1.2.2.md)
