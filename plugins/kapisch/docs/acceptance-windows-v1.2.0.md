# Windows acceptance record — 1.2.0

**Status: PENDING.** This file is the release-candidate acceptance template, not
evidence that the 1.2.0 tag, release, or live runtime acceptance exists.

- Release: `1.2.0`; intended immutable tag: `v1.2.0`.
...
[issue #23](https://github.com/twKrash/kapisch/issues/23); 1.2.0 makes no claim
