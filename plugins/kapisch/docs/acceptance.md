...
| 1.2.2 legacy-profile upgrade hotfix candidate | pending Windows coverage, independent review, final readiness, and release preparation | [1.2.2 Windows template](acceptance-windows-v1.2.2.md) |
