...
supported durable version-3 or version-4 graph or relax the constraint; it is
never silently executed natively. An automatic capability selection may use
